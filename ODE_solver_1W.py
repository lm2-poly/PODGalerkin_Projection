...
from projection_matrices_1W import *
...
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    C_D = np.mean(Fx_POD_romcoeffs)*np.pi*Mass_number/2
    ...
    Lambda[1,1] = - (Zeta)* Mass_number/(1+Mass_number)
    
    # Line 3
    Lambda[2,3] = 1
    # Line 4
    Lambda[3,2] = - (2*np.pi/Ur)**2 * Mass_number/(1+Mass_number)
    Lambda[3,3] = - (Zeta)* Mass_number/(1+Mass_number)
