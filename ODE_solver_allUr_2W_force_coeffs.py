...
for i_ur in tqdm(range(len(all_Ur))):
    ...
    C_D =  Fx_mean_CFD * nCond.include_added_damping_force #*7.5 #-gamma_bar_x_value*np.pi*nCond.Mass_number/2 
    # ------------------------------------------------------------------------------------------------------------------
...
no_force_coeff_amplitudes = pd.read_csv("C:\\Users\\Student\\Downloads\\data_amplitudes.csv")

plt.figure(figsize=(10,12))
plt.plot(all_Ur[:],eta_amplitudes_max[:], color='darkblue', marker = 's', label = "2W ROM, force coeffs.")
plt.plot(FSI_sim_Ur_x, true_eta_max, 'k-', marker='o', markerfacecolor='none', markeredgecolor='k' )
plt.plot(no_force_coeff_amplitudes['ur'],no_force_coeff_amplitudes['eta'], label = '2W ROM,  only pressure coeffs.',color="#004e7c", marker = 'o')
plt.xlabel("$U_r$")
plt.ylabel("$\eta_{max}$")
plt.legend()
plt.show()
...
plt.figure(figsize=(10,12))
plt.plot(all_Ur[:],xi_amplitudes_max[:], color="#FF7F00", marker = 's',label = "2W ROM,  force coeffs.")
plt.plot(FSI_sim_Ur_y, true_xi_max, 'k-', marker='o', markerfacecolor='none', markeredgecolor='k' )
plt.plot(no_force_coeff_amplitudes['ur'],no_force_coeff_amplitudes['xi'], label = '2W ROM, only pressure coeffs.',color='darkred', marker = 'o')
plt.legend()
plt.xlabel("$U_r$")
plt.ylabel("$\\xi_{max}$")
plt.show()
